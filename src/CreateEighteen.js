...
const CreateEighteen = () => {
  ...
  const [tc, setTc] = useState('');
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/createeighteen', {rollno, name, dob, gender, fathername, mothername, address, adharno, panno, telephone, email, category, qualification, marks, subject1, subject2, yopass, currentjob, tc})
        .then(res => {
            console.log(res);
             alert('Student Added Successfully');
             navigate('/studentEighteen');
         })
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='row mb-2'>
            <div className='col'>
              ...
              <input id='name1' type='text' className='form-control' placeholder='Enter Adm No' required
          ...
          <div className='row mb-2'>
            ...
            <div className='col'>
              ...
              <input id='dob2' type='text' className='form-control' placeholder='Enter Gender' required
          ...
          <div className='row mb-2'>
            ...
            <div className='col'>
              ...
              <input id='name2' type='text' className='form-control' placeholder='Enter MotherName' required
          ...
          <div className='row mb-2'>
            ...
            <div className='col'>
              ...
              <input id='name2' type='text' className='form-control' placeholder='Enter Adhar Number' required
          ...
          <div className='row mb-2'>
            <div className='col'>
              ...
              <input id='name1' type='text' className='form-control' placeholder='Enter Pan No' required
              onChange={(e) => setPanno(e.target.value)} />
            </div>
            <div className='col'>
              <label htmlFor='name2' className='text-danger'>Telephone</label>
              <input id='name2' type='text' className='form-control' placeholder='Enter Telephone' required
          ...
          <div className='row mb-2'>
            <div className='col'>       
              ...
              <input id='name1' type='text' className='form-control' placeholder='Enter Email' required
          ...
          <div className='row mb-2'>
            ...
            <div className='col'>
              ...
              <input id='name2' type='text' className='form-control'  placeholder='Enter Subject2' required
              onChange={(e) => setSubject2(e.target.value)} />
            </div>
          </div><div className='row mb-2'>
            <div className='col' >
              <label htmlFor='name1' className='text-danger'>YearOfPass</label>
              <input id='name1' type='text' className='form-control' placeholder='Enter YearofPass' required
              onChange={(e) => setYopass(e.target.value)} />
            </div>
            <div className='col'>
              <label htmlFor='name2' className='text-danger'>CurrentJob</label>
              <input id='name2' type='text' className='form-control'  placeholder='Enter CurrentJob' required
              onChange={(e) => setCurrentJob(e.target.value)} />
            </div>
          </div>
          <div className='col'>
              <label htmlFor='name2' className='text-danger'>TC Issue</label>
              <input id='name2' type='text' className='form-control'  placeholder='Enter TC Issue' required
