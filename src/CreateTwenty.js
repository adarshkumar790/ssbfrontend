...
const CreateTwenty = () => {
  ...
  const [tc, setTc] = useState('');
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/createtwenty', {rollno, name, dob, gender, fathername, mothername, address, adharno, panno, telephone, email, category, qualification, marks, subject1, subject2, yopass, currentjob, tc})
        .then(res => {
            console.log(res);
             alert('Student Added Successfully');
             navigate('/studentTwenty');
         })
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='row mb-2'>
            ...
            <div className='col'>
              ...
              <input id='name2' type='text' className='form-control'  placeholder='Enter Occupation'               onChange={(e) => setCurrentJob(e.target.value)} />
            </div>
          </div>
          <div className='col'>
