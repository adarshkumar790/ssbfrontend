...
const CreateTwentytwo = () => {
  ...
  const [tc, setTc] = useState('');
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/createtwentytwo', {rollno, name, admno, gender, fathername, mothername, address, adharno, panno, telephone, email, category, qualification, marks, subject1, subject2, yopass, currentjob, tc})
        .then(res => {
            console.log(res);
             alert('Student Added Successfully');
             navigate('/studentTwentytwo');
         })
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='row mb-2'>
            ...
            <div className='col' >
              ...
              <input id='name1' type='text' className='form-control' placeholder='Enter Category' 
...
export default CreateTwentytwo;
