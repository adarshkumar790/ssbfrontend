...
const CreateSixteen = () => {
  ...
  const [tc, setTc] = useState('');
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/createsixteen', {rollno, name, dob, gender, fathername, mothername, address, adharno, panno, telephone, email, category, qualification, marks, subject1, subject2, yopass, currentjob, tc})
        .then(res => {
            console.log(res);
             alert('Student Added Successfully');
             navigate('/studentSixteen');
         })
