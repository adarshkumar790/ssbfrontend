...
const StudentTwentyone = () => {
    const [students, setStudents] = useState([]);
   
    useEffect (()=>{
      axios.get('http://localhost:8081/studenttwentyone/')
    ...
    const handleDelete = async(id) => {
       try {
        await axios.delete('http://localhost:8081/studenttwentyone/'+id)
    ...
    return (
        <div className='d-flex vh-100 bg-danger justify-content-center align-items-center'>
            ...
            <div className="d-flex justify-content-between align-items-center mb-3"> {/* Align to the right */}
                    <h3 className="text-center">Session 2021-2023</h3> {/* Center the session header */}
                    <Link to="/createtwentyone" className='btn btn-dark'>Add Student Details</Link>
                </div>
                    ...
                    <div className='table-container' style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 100px)' }}>
                        <table className='table table-bordered' style={{ fontSize: '0.8rem' }}>
                            ...
                            <tbody>
                                    ...
                                    <tr key={i}>
                                        ...
                                        <td>
                                            <div className="btn-group" role="group">
                                                <Link to={`studenttwentyone/${data.ID}`} className='btn btn-primary'>Update</Link>
                                ...
                                <tr>
                                  <td colSpan="21" className="text-center">No students In Database</td>
                                </tr>
                              )}
                            </tbody>
                        </table>
...
export default StudentTwentyone;
